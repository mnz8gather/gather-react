...
export const WithoutDragOverlay = () => <Sortable {...props} useDragOverlay={false} />;
...
export const Swappable = () => (
  <Sortable
    ...
    getNewIndex={({ id, items, activeIndex, overIndex }) => arraySwap(items, activeIndex, overIndex).indexOf(id)}
  />
);
