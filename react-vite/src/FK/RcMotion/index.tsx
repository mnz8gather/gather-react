...
class Demo extends React.Component<{}, DemoState> {
  ...
  render() {
    const { show, forceRender, motionLeaveImmediately, removeOnLeave, hasMotionClassName, prepare } = this.state;
    ...
    return (
      <div>
        ...
        <label>
          <input type='checkbox' onChange={this.onTriggerClassName} checked={hasMotionClassName} /> hasMotionClassName
        </label>

        <label>
          <input type='checkbox' onChange={this.onForceRender} checked={forceRender} /> forceRender
        </label>

        <label>
          <input type='checkbox' onChange={this.onRemoveOnLeave} checked={removeOnLeave} /> removeOnLeave
          {removeOnLeave ? '' : ' (use leavedClassName)'}
        </label>

        <label>
          <input type='checkbox' onChange={this.onTriggerDelay} checked={prepare} /> prepare before motion
        </label>
        ...
        <div className='grid'>
          ...
          <div>
            ...
            >
              {({ style, className }) => <div className={classNames('demo-block', className)} style={style} />}
            </CSSMotion>
          </div>
        </div>
